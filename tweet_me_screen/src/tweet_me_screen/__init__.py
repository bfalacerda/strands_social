...
def create_tweet_me_page(full_path, image_topic, headline, sayings, other_button='', image_host='localhost'):		
	...
	page = str(render.tweet_me(image_topic, headline, sayings, other_button, image_host))
